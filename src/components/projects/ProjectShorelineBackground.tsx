...
export const ProjectShorelineBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden select-none">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#14532d] via-[#166534] to-[#14532d]" />
      ...
      <div className="absolute top-1/4 left-1/3 w-[550px] h-[550px] rounded-full bg-[#22c55e]/15 blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/3 right-1/4 w-[600px] h-[600px] rounded-full bg-[#eab308]/15 blur-3xl pointer-events-none" />
    </div>
  );
};
