...
const DUCK_DIALOGUES = [
  '♪ Kwek kwek, asyiknya berenang di kolam peternakan ~',
  'Air kolamnya segar banget hari ini!',
  'Tadi kulihat si ayam lagi sibuk periksa faktur pajak!',
  'Pembukuan rapi dan rekonsiliasi fiskal aman terkendali!',
  'Kwek! Jangan lupa lapor SPT Masa tepat waktu ya!',
  'Berenang santai sambil nemenin kamu lihat portofolio Kak Intan Srimaya ~',
  'Peternakan damai, laporan keuangan wajar tanpa pengecualian!'
];
