...
> = {
  client: {
    ...
    description:
      'Pengembangan antarmuka website yang responsif dan interaktif menggunakan HTML, CSS, JavaScript, TypeScript, React, Vite, dan Tailwind CSS dengan fokus pada struktur, tampilan, serta pengalaman pengguna.',
    guarantees: [
  ...
  backend: {
    ...
    subtitle: 'Logic & Application Systems',
    description:
      'Pengembangan logic aplikasi, autentikasi, pengelolaan data, API, dan sistem berbasis database menggunakan PHP, CodeIgniter, serta teknologi backend yang relevan dengan kebutuhan proyek.',
    guarantees: [
      'Application Logic',
  ...
  database: {
    ...
    subtitle: 'Data Structure & Management',
    description:
      'Pengelolaan database dan data aplikasi mulai dari perancangan struktur, penyimpanan, pencarian, relasi data, hingga integrasi database dengan sistem digital.',
    guarantees: [
  ...
  devops: {
    ...
    subtitle: 'Version Control & Deployment',
    description:
      'Penggunaan tools pendukung pengembangan seperti Git, GitHub, Vercel, Figma, serta workflow pengembangan untuk membantu proses coding, kolaborasi, dokumentasi, dan deployment.',
    guarantees: [
      'Git & Version Control',
      'Deployment Workflow',
